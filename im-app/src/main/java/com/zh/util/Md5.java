...
public class Md5 {
    ...
    /**
     * @param plainText
     * @param md532 ，如果为false则返回16位的加密串
     * @return
     */
    public static final String encode(String plainText, boolean md532) {
    ...
    public static void main(String[] args) {
        System.out.println(Md5.encode("123456", true));
